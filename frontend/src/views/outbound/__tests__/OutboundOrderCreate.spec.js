...
vi.mock('../../../composables/useOutboundCreatePage', () => ({
...
import OutboundOrderCreate from '../OutboundOrderCreate.vue'
...
const AiOutboundRecognitionDialogStub = defineComponent({
  name: 'AiOutboundRecognitionDialog',
  template: '<div class="ai-outbound-recognition-dialog-stub"></div>'
})
...
const mountView = () => {
  return mount(OutboundOrderCreate, {
    global: {
      stubs: {
        ...
        AiOutboundRecognitionDialog: AiOutboundRecognitionDialogStub
      }
    }
  })
}

describe('OutboundOrderCreate', () => {
  beforeEach(() => {
