...
1. [系统设计总览](./design/system-design-overview.md) — 规范目录下的系统边界、逻辑组成与核心流程入口
2. [架构设计说明](./架构设计说明.md) — 当前详细架构说明、技术栈与模块关系
3. [数据库设计](./database.md) — 12 张表结构、枚举值定义
4. [本地环境搭建](./guides/setup.md) — 从零启动系统的完整步骤
5. [系统现状与风险清单](./系统现状与风险清单.md) — 当前运行边界、已收敛问题、高风险项
...
| 文档 | 说明 | 目标读者 |
|------|------|---------|
| [design/system-design-overview.md](./design/system-design-overview.md) | 规范目录下的系统边界、核心流程与逻辑组成入口 | 所有开发者 |
| [design/architecture-overview.md](./design/architecture-overview.md) | 规范目录下的架构摘要与分层职责桥接文档 | 所有开发者 |
| [design/database-design.md](./design/database-design.md) | 规范目录下的数据库摘要与结构入口 | 后端开发者 |
